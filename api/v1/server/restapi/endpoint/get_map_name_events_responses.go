...
type GetMapNameEventsOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.MapEventLog `json:"body,omitempty"`
}
...
func (o *GetMapNameEventsOK) WithPayload(payload *models.MapEventLog) *GetMapNameEventsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get map name events o k response
func (o *GetMapNameEventsOK) SetPayload(payload *models.MapEventLog) {
	o.Payload = payload
}
