...
func NewDaemon(ctx context.Context, cancel context.CancelFunc, epMgr *endpointmanager.EndpointManager, dp datapath.Datapath,
	ciliumClient ciliumClient.CiliumV2Interface) (*Daemon, *endpointRestoreState, error) {
