...
type eventsDumper interface {
	DumpAndSubscribe(cb bpf.EventCallbackFunc, follow bool) *bpf.Handle
...
// TODO: This is not safe, is there a way we can refactor to make changes to metrics.ResponderWrapper fail
...
func (h *getMapNameEvents) Handle(params restapi.GetMapNameEventsParams) middleware.Responder {
	...
	return middleware.ResponderFunc(func(w http.ResponseWriter, _ runtime.Producer) {
		...
		h := m.DumpAndSubscribe(writeEventFn, follow)
